...
class UpdateJobSeeker extends React.Component {
    constructor(props){
        super(props);
        this.state={
            experience: '',
            ...
            <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-33-l mw6 shadow-5 center">
                <main className="pa4 black-80">
                    <div className="measure center">
                        ...
                        <legend className="f2 fw6 ph0 mh0">UPDATE Job Seeker</legend>
                        <div className="mt3">
                            <label className="db fw6 lh-copy f6" htmlFor="jobseekerId">Job Seeker Id</label>
                            <input 
                            className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" 
                            type="number" name="jobseekerId"  id="jobSeekerId"
